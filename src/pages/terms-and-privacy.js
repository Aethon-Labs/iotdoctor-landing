...
const TermsOfUse = () => (
  <>
    ...
    <p>Version 1.0</p>
    <p>
      The IoTDoctor website located at iotdoctor.com is a copyrighted work
      belonging to Aethon Labs LLC. Certain features of the Site may be subject
    ...
    <p>
      ...
      such interactions. If there is a dispute between you and any Site user, we
    ...
    <p>
      ...
      IoTDoctor uses 'cookies'. These cookies are used to store information
    ...
    <p>
      <strong>Our Advertising Partners.</strong> Some of advertisers on our site
      may use cookies and web beacons. Our advertising partners are listed
      below. Each of our advertising partners has their own Privacy Policy for
      their policies on user data. For easier access, we hyperlinked to their
    ...
    <p>
      ...
      should be sent to: 446 Old County Rd Ste 100-374, Pacifica, CA 94044.
      After the Notice is received, you and the Company may attempt to resolve
      the claim or dispute informally. If you and the Company do not resolve the
    ...
    <p>
      ...
      the other. These Terms, and your rights and obligations herein, may not be
    ...
    <p>Address: 446 Old County Rd Ste 100-374, Pacifica, CA 94044</p>
    <p>Email: legal@aethonlabs.com</p>
  </>
)

const PrivacyPolicy = () => (
  <>
    <h2 id="privacy">Privacy Policy for Aethon Labs LLC</h2>

    <p>
      At IoTDoctor, accessible from iotdoctor.com, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by IoTDoctor and how we use
      it.
    </p>
    ...
    <p>
      ...
      and/or collect in IoTDoctor. This policy is not applicable to any
    ...
    <p>
      IoTDoctor follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, IoTDoctor uses 'cookies'. These cookies are used
    ...
    <p>
      ...
      advertising partners of IoTDoctor.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on IoTDoctor, which are sent directly
    ...
    <p>
      Note that IoTDoctor has no access to or control over these cookies that
    ...
    <p>
      IoTDoctor's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      IoTDoctor does not knowingly collect any Personal Identifiable Information
